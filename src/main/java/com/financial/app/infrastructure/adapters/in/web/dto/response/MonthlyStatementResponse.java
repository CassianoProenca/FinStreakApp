...
public record MonthlyStatementResponse(
        ...
        @Schema(description = "Mês do extrato (1-12)", example = "2")
        int month,

        @Schema(description = "Ano do extrato", example = "2026")
        int year,

        @Schema(description = "Saldo no início do mês (acumulado até o dia anterior)", example = "1000.00")
        ...
        @Schema(description = "Saldo no encerramento do mês", example = "1800.00")
        BigDecimal closingBalance,

        @Schema(description = "Gastos agrupados por categoria")
        Map<String, BigDecimal> spendingByCategory,

        @Schema(description = "Lista de transações do mês")
